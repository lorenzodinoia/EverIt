...
import it.uniba.di.sms1920.everit.customer.activities.LauncherActivity;
...
public class CustomerNotificationService extends FirebaseMessagingService {
            ...
            if (data.containsKey("click_action")) {
                ...
                if (clickIntent.resolveActivity(this.getPackageManager()) != null) {
                    ...
                    if (AppLoader.isComponentsLoaded()) {
                        ...
                        launcherActivityIntent.putExtra(LauncherActivity.FLAG_REQUIRE_LOGIN, true);
